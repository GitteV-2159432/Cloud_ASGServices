...
Route::get('/soapAddMember', [AttendanceController::class, "addMemberForm"]);
Route::post('/add-member', [AttendanceController::class, "NewMember"]);
Route::get('/addSamples', [AttendanceController::class, "addSampleData"]);
